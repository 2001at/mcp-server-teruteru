import z from "zod";
export const carControl = async (mcpServer, serialService) => {
    // @ts-ignore
    mcpServer.tool("carControl", "ESP32 にシリアルで「コマンド,時間」を送信すると、車をその通りに動かします。{command} は動作の種類、{duration} は動作時間（ミリ秒）です。", {
